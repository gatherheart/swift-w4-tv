...
struct TvUseCase {
    static func getOriginal(with manager: NetworkManable, completed: @escaping (TvModelList?) -> Void) {
    ...
    static func getLive(with manager: NetworkManable, completed: @escaping (TvModelList?) -> Void) {
